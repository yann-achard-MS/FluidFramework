...
const changes: Change[] = [
	{ type: ChangeType.Detach, destination: 0, source: { first: 0xd, last: 0xd } }, // Detach D
	{ type: ChangeType.Detach, destination: 1, source: { first: 0xc, last: 0xc } }, // Detach C
	{ type: ChangeType.Detach, destination: 2, source: { first: 0xb, last: 0xb } }, // Detach B
	{ // Attach C
		type: ChangeType.Insert,
		source: 1,
		destination: {
			extremity: Extremity.Start,
			parent: { nodeId: 0xa },
			label: "foo",
...
const terse =
[
	{ id: 0, src: 0xd }, // Detach D
	{ id: 1, src: 0xc }, // Detach C
	{ id: 2, src: 0xb }, // Detach B
	{ id: 1, dst: { parent: 0xa, label: "foo" } }, // Attach C
	{ id: 2, dst: { parent: 0xc, label: "bar" } }, // Attach B
	{ id: 0, dst: { parent: 0xb, label: "baz" } }, // Attach D
];