...
describe("SquashingTransactionStacks", () => {
	...
	type DefaultBranch = SharedTreeBranch<IdBasedChangeFamilyDataEditor, DefaultChangeset>;
	...
	function edit(editor: IdBasedChangeFamilyDataEditor, value: string): void {
