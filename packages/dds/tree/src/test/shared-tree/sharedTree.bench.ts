...
describe("SharedTree benchmarks", () => {
	...
	describe("rebasing over op bunch", () => {
		...
		// If opp bunching is used, then the time taken to rebase the local branch over the bunch should be proportional to `bunchSize + localBranchSize` instead of `bunchSize * localBranchSize`.
