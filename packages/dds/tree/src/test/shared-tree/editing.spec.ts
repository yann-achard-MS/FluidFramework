...
describe("Editing", () => {
    describe("Sequence Field", () => {
        ...
        // This occurs because the rebase of (e.g.,) the insertion of s over the insertion of c
        // orders s before c.
        // Having merge-right tie-breaking does preserve groupings but in a first-to-last order,
        // and it breaks the groups in the LTR test. This would be the desired outcome for RTL text.
        // TODO: activate this test once merge-right is supported.
